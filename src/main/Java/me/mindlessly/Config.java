...
public class Config extends Vigilant {
    ...
    public Config() {
        super(CONFIG_FILE, "FlippingEternal Configuration", new JVMAnnotationPropertyCollector(), new CustomSorting());
        initialize();
    }
    ...
    public static void github() {
        UDesktop.browse(URI.create("https://www.youtube.com/watch?v=dQw4w9WgXcQ"));
    }
    ...
    public static void discord() {
        UDesktop.browse(URI.create("https://discord.gg/GSQWA2FmSs"));
    }
}
