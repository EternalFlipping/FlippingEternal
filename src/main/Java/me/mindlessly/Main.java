...
public class Main {
    ...
    public void init(FMLInitializationEvent event) {
        ProgressManager.ProgressBar progressBar = ProgressManager.push("FlippingEternal", 4);
        ...
        try {
            ...
            e.printStackTrace();
            Reference.logger.error("FlippingEternal have been disabled due to an error while authenticating. Please check the logs for more information.");
            return;
        }
